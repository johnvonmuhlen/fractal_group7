...
from util import handle_zoom, handle_zoom_buttons, randomize_settings, reset_to_default
...
ToolTip(scale_slider_label, msg="You can change the size of the tree by this slider")
...
scale_slider.set(70)
scale_slider.pack()
ToolTip(scale_slider, msg="the depth of the tree will change")
